...
if(isset($_POST["submit"])){
  ...
  $adminUsernameUpdate = $admin->updateAdminUsername($adminId, $_POST); 
...
<main role="main" class="col-7 col-sm-8 col-lg-9 ml-sm-auto pt-3 px-4"> 
          ...
          <div class="container">
              <div class="row">
                ...
                <?php 
                    if(isset($adminUsernameUpdate)){
                        echo $adminUsernameUpdate;
                    }
                ?>
                ...
                <tr>
                    <td colspan="2"> <h2>Update Admin Username</h2> </td>   
                </tr>
                <tr>
                    <td> Username </td>
                    <td><input class="form-control" type="text" name="username" value="<?php echo $result["username"];?>"></td>
                </tr>
                    <td></td>
